        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              ...
              <div class="row no-gutters align-items-center">
                <div class="col-auto">
                  <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">Dominion</div>
                </div>
              </div>
            </div>
            <div class="col-auto d-flex justify-content-center">
              <div class="text-lg text-gray-700 d-flex justify-content-center">10</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
          ...
          <p>
            ...
            <a target="_blank" rel="nofollow" href="https://undraw.co/">unDraw</a>, a constantly
